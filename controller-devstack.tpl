...
write_files:
  - content: |
        ...
        echo ENABLED_SERVICES+=,q-svc,q-agt,q-dhcp,q-l3,q-meta,s-proxy,s-object,s-container,s-account  >> local.conf
        echo SWIFT_HASH=swift >> local.conf
        echo disable_service n-net n-cpu c-vol>> local.conf
        ./stack.sh
